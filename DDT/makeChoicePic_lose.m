function nowLeft = makeChoicePic_lose( delayTime, delayReward, nowReward )
...
loc = Shuffle( [ 0.3 0.7 ] );
text( loc(1), 0.65, '希望现在失去：', 'HorizontalAlignment', 'center', 'FontName', textFont, 'FontSize', textSize, 'Color', 'w' )
text( loc(1), 0.55, num2str( nowReward ), 'HorizontalAlignment', 'center', 'FontName', textFont, 'FontSize', textSize, 'Color', 'y' )
text( loc(2), 0.65, [ '希望' delayTime '后失去：' ], 'HorizontalAlignment', 'center', 'FontName', textFont, 'FontSize', textSize, 'Color', 'w' )
